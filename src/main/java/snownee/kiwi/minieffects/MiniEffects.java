...
//		}
	...
	public static boolean allowClick(EffectRenderingScreen screen, double x, double y) {
		...
		if (!effects.kiwi$isExpanded() && buttonArea != null && buttonArea.containsPoint((int) x, (int) y)) {
	...
	public static boolean afterClick(EffectRenderingScreen screen, double x, double y) {
		KiwiEffectsInInventory effects = (KiwiEffectsInInventory) screen.kiwi$effects();
