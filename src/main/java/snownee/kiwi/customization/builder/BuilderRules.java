...
//			BlockFamily family = Objects.requireNonNull(BlockFamilies.get(new ResourceLocation("test:wool")));
//			families.put(new ResourceLocation("wool"), new ReplaceInHandRule(Map.of(family, family), blockSpread));
//
//			blockSpread = new BlockSpread(BlockSpread.Type.PLANE_Y, FacingLimitation.None, 16);
//			family = Objects.requireNonNull(BlockFamilies.get(new ResourceLocation("test:fence_gate")));
//			families.put(new ResourceLocation("fence_gate"), new CyclePropertyRule(Map.of(family, "open"), blockSpread));
//		}
