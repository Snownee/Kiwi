...
public class CustomizationRegistries {
	...
	public static final ResourceKey<Registry<BuilderRule.Type<?>>> BUILDER_RULE_KEY = ResourceKey.createRegistryKey(Kiwi.id(
			"builder_rule"));
	public static Registry<BuilderRule.Type<?>> BUILDER_RULE;
}
