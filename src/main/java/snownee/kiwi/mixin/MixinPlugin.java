...
public class MixinPlugin implements IMixinConfigPlugin {
	...
	public void onLoad(String mixinPackage) {
		...
		persistentCreativeInventory =
				customization || FabricLoader.getInstance().isModLoaded("persistentcreativeinventory") || FabricLoader.getInstance()
						.isDevelopmentEnvironment();
		fastsuite = customization && FabricLoader.getInstance().isModLoaded("fastsuite");
		fastScrolling = FabricLoader.getInstance().isModLoaded("fastscroll") || FabricLoader.getInstance().isDevelopmentEnvironment();
	}
