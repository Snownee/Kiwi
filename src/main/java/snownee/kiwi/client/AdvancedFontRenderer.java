...
//    {
//        return character == '锛�' || character == '锛�' || character == '锛�' || character == '锛�' || character == '锛�' || character == '鈥�' || character == '鈥�' || character == '锛�' || character == '锛�' || character == '锝�' || character == '锝�' || character == '锛�' || character == '锛�' || character == '鈥�' || character == '鈥�';
//    }
//
...
//    // with changes to support extended formatting code 搂x{hex_color}
//    @Nonnull
//    @Override
...
//        String hexColor = ""; // Used for 搂x support
...
//     *   1. Skip 6 characters when encountered 搂x
//     */
//    @Override
...
//            if (width < 0) // \u00A7 (`搂`) is considered as having width of -1
//            {
//                ++index;
