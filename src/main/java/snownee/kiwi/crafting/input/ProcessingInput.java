...
public interface ProcessingInput
{
    ...
    /**
     * Return the "size" of this. The definition of "size" should be compatible
     * to that of {@link ItemStack#getCount()}. This is provided to allow
     * custom input consumption handling.
     *
     * @return The actual size of this.
     */
    int count();
}
